...
class TestMonsterCombat(TestCase):
    @patch('sys.stdout', new_callable=io.StringIO)   # Tests case where the monster dies
...
Ghoul has died\n"""
    ...
    @patch('sys.stdout', new_callable=io.StringIO)  # Tests case where the character dies
