...
class TestCreateCharacter(TestCase):
    ...
    @patch('A2.dungeonsanddragons.choose_class', return_value='blood hunter')  # Mock class input
    ...
    @patch('A2.dungeonsanddragons.choose_class', return_value='barbarian')   # Mock class input
    ...
    @patch('A2.dungeonsanddragons.choose_class', return_value='wizard')  # Mock class input
